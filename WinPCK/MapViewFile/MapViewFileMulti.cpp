...
LPBYTE CMapViewFileMulti::View(QWORD dwAddress, DWORD dwSize, BOOL isReadOnly)
{
	...
	if(iCellIDBegin == iCellIDEnd) {
		...
		//if(isReadOnly) {
		//	CMapViewFileRead *lpRead = (CMapViewFileRead*)m_file_cell[iCellIDBegin].lpMapView;

		//	return lpRead->View(dwRealAddress, dwSize);
		//} else {
		//	CMapViewFileWrite *lpWrite = (CMapViewFileWrite*)m_file_cell[iCellIDBegin].lpMapView;

		//	return lpWrite->View(dwRealAddress, dwSize);
		//}
