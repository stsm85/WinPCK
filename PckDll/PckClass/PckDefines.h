...
#define	TEXT_LOG_LEVEL_THREAD			"压缩率={}:线程={}"
...
//#define	TEXT_LOG_CREATE					"新建PCK文件:{}..."
...
#define	TEXT_CREATEMAPNAME_FAIL			"映射文件\"{}\"失败！"
#define	TEXT_OPENNAME_FAIL				"打开文件\"{}\"失败！"
#define	TEXT_VIEWMAP_FAIL				"创建映射视图失败！"
#define	TEXT_VIEWMAPNAME_FAIL			"文件\"{}\"创建映射视图失败！"

#define TEXT_READ_INDEX_FAIL			"文件索引表读取错误！"
#define TEXT_UNKNOWN_PCK_FILE			"无法识别的PCK文件！"

#define	TEXT_OPENWRITENAME_FAIL			"打开写入文件\"{}\"失败！"
...
#define	TEXT_UNCOMPRESSDATA_FAIL		"文件 {} 数据解压失败！"
#define	TEXT_UNCOMPRESSDATA_FAIL_REASON	"数据解压失败: {}"
...
#define TEXT_UPDATE_FILE_INFO			"预添加文件数={}:预期文件大小={}, 开始进行作业..."
