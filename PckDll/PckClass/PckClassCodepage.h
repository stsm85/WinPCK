...
public:
	...
	//ansi -> uc cp936
	static size_t	PckFilenameCode2UCS(const char* _in, size_t _insize, wchar_t* _out, size_t _outsize);
	//uc -> ansi cp936
	static size_t	PckFilenameCode2Ansi(const wchar_t* _in, size_t _insize, char* _out, size_t _outsize);
